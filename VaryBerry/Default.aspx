...
<asp:Content ID="Content2" ContentPlaceHolderID="Contents" runat="server">
	<div id="BerryProposalsCarousel" class="carousel slide" data-ride="carousel" style="background-color: #C9C9C9; height: 280px;">
		<!-- carousel 하단 바 -->
		...
		<div class="carousel-inner" style="height: 100%;">
			<div class="carousel-item active carousel-item-next carousel-item-left" style="height: 100%;">
				<div class="carousel-caption text-center" style="height: 100%; right: 0; left: 0;">
					<img src="/assets/img/Event.jpg" style="height: auto; max-width: 100%;" />
				</div>
			</div>
			
			<div class="carousel-item carousel-item-next carousel-item-left" style="height: 100%;">
				<div class="carousel-caption text-center" style="height: 100%; right: 0; left: 0;">
					<img src="/assets/img/Facilities.jpg" style="height: auto; max-width: 100%;" />
				</div>
			</div>
			...
			<div class="carousel-item carousel-item-next carousel-item-left" style="height: 100%;">
				<div class="carousel-caption text-center" style="height: 100%; right: 0; left: 0;">
					<img src="/assets/img/Organization.jpg" style="height: auto; max-width: 100%;" />
				</div>
			</div>
		</div>
