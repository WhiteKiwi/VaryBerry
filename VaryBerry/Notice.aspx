<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Navbar.Master" AutoEventWireup="true" CodeBehind="Notice.aspx.cs" Inherits="VaryBerry.Notice" %>
					...
					<%
						try {
							...
							using (MySql.Data.MySqlClient.MySqlConnection conn = new MySql.Data.MySqlClient.MySqlConnection(connectionString)) {
								...
								// Reading Data
								sql = "SELECT * FROM Notices ORDER BY Id DESC limit 9";
								msc.CommandText = sql;
